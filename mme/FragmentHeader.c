...
/*====================================================================*
 *
 *   signed FragmentHeader (struct qualcomm_fmi * header, uint8_t MMV, uint16_t MMTYPE, uint16_tFMI);
 *
 *   mme.h 
 *
...
signed FragmentHeader (struct qualcomm_fmi * header, uint8_t MMV, uint16_t MMTYPE) 
