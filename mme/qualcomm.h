...
#define VS_RX_TONEMAP_CHAR 0xA090
#define VS_SET_LED_BEHAVIOR 0xA094
#define VS_WRITE_EXECUTE 0xA098
...
#define VS_SLEEP_SCHED 0xA0E4 
#define VS_RSVD_18 0xA0E8 
#define VS_RSVD_19 0xA0EC 
#define VS_MICROCONTROLLER_DIAG 0xA0F0 
#define VS_DEBUG_INFO 0xA0F4
#define VS_GET_PROPERTY 0xA0F8
#define VS_RSVD_21 0xA0FC
